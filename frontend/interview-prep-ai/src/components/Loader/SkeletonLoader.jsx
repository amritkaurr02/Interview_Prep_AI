...
const SkeletonLoader = () => {
  return (
    <>
      <div role="status" aria-label="Loading content" className="animate-pulse space-y-4 max-w-3xl">
      ...
      <div role="status" aria-label="Loading content" className="animate-pulse space-y-4 max-w-3xl mt-10">
